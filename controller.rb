...
def create_grid_array                       # This creates the values 1-100 that correspond to the gridsquares 
    $b_g = Array.new(101, " ")
end

REFERENCE_HASH = {                          # The hash converts grid values 1-100 to alpha numeric references used in the game
    "A1" => 1,
    "A2" => 2,
    "A3" => 3,
    "A4" => 4,
...
def get_orientation                         # This is a helper method used in the positioning of the ships.
